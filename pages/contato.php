<section id="breadcrumbs">
    <div class="uk-container">
        <div class="contentBreadcrumb">
            <p class="uk-margin-remove">Contato</p>
        </div>
    </div>
</section>
...
<section id="mainBlock">
    <div class="uk-container">
        <div class="contactBlock">
            <div class="indicator">
                <p class="uk-margin-remove">Envie sua Mensagem</p>
            </div>
        </div>
    </div>
</section>
                    ...
                    <form class="uk-grid-small" action="" method="POST" uk-grid>
                        ...
                        <div class="uk-width-1-3@s">
                            ...
                            <div class="uk-form-controls">
                                ...
                                <label><input class="uk-radio" type="radio" name="radio1"> Fiscal</label><br>
                        ...
                        <div class="uk-width-1-3@s blockThree">
                            <div class="uk-form-controls">
                                ...
                                <label><input class="uk-radio" type="radio" name="radio1"> Recursos Humanos</label><br>
                            </div>
                        </div>
                        <div class="uk-width-1-1">
                            <button type="submit" class="uk-button uk-button-default uk-width-1-1">Enviar Mensagem</button>
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <div class="uk-child-width-1-2@s uk-child-width-1-3@m" uk-grid>
                            <div>
                                <div>
                                    ...
                                    <p class="uk-margin-remove-top"><a href="tel:1140139966">(11) 4013-9966</a></p>
                                    <small class="uk-margin-top">Whats App:</small>
                                    <p class="uk-margin-remove-top"><a href="">(11) 0000-0000</a></p>
                                    <small class="uk-margin-top">E-mail:</small>
                                    <p class="uk-margin-remove-top"><a class="mail" href="mailto:vendas@tsadobrasil.com.br">vendas@tsadobrasil.com.br</a>
                                </div>
                            </div>
                            <div>
                                <div>
                                    ...
                                    <p class="uk-margin-remove-top"><a href="">(11) 0000-0000</a></p>
                                    <small>Skype:</small>
                                    <p class="uk-margin-remove-top"><a class="mail" href="">assistencia.tsadobrasil</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
